...
$notes = $db->prepare("SELECT note_id, note_fill, print_id FROM notes order by NOTE_ID desc LIMIT 5");
$notes->execute();

$prints = $db->prepare("SELECT print_id, print_name, filament_amount FROM prints order by print_id desc LIMIT 5");
$prints->execute();
?>
<!DOCTYPE html>
<html>
