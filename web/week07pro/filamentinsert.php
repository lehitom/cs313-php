...
try
{
	$query = 'INSERT INTO filaments(filament_id, filament_name, filament_cost, filament_size, filament_diameter, filament_vendor, filament_color) VALUES(nextval(filament_id), :filament_name, :filament_cost, :filament_size, :filament_diameter, :filament_vendor, :filament_color)';
